...
<body class="bg-gray-100 font-[Inter]">
    <div class="min-h-screen flex">
        ...
        {{-- Sidebar --}}
        <x-admin.sidebar brand="E-Lab" subtitle="Dashboard Admin" />

        {{-- Main navbar --}}
        <div class="flex-1 lg:ml-72">
            <x-admin.navbar :page="$page" :pageTitle="$pageTitle" />
    ...
    {{-- <x-admin.settings-panel title="UI Settings" subtitle="Customize the appearance of the admin panel" /> --}}
